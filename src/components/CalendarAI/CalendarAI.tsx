...
// Guard: only create client if env vars are present
const supabase =
...
// Fallback shown when Supabase is not configured (no .env)
function CalendarAIUnavailable() {
  return (
    ...
    >
      <h1 style={{ margin: 0, textShadow: "var(--title-shadow)" }}>CalendarAI</h1>
      <p style={{ color: "var(--text-muted)", maxWidth: "440px", lineHeight: 1.7 }}>
        ...
        Bitte besuche{" "}
        <a href="https://spiri.pages.dev" style={{ color: "var(--accent)" }}>
          spiri.pages.dev
        </a>{" "}
...
function CalendarAI() {
  ...
  // If Supabase is not configured, show maintenance notice
  if (!supabase) {
    return <CalendarAIUnavailable />;
  }
      ...
      <div style={styles.page}>
        <div style={styles.shell}>
          <div style={styles.header}>
            ...
            <p style={{ margin: 0, opacity: 0.8, lineHeight: 1.6, textAlign: "center" }}>
          ...
          <p style={{ ...styles.loginFootnote, textAlign: "center" }}>
